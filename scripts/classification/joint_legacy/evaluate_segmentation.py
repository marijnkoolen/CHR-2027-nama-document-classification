...
def macro_f1_report(df: pd.DataFrame, true_col: str, pred_col: str, classes: list[str] | None) -> dict:
    ...
    # inflates the score, especially for rare/merged classes). weighted
    # metrics don't have the same blind spot (support-weighted, so a
    # zero-support class contributes 0 weight either way) but are computed
...
def main():
    ...
    parser.add_argument("--true-layout-col", default="layout_type")
    parser.add_argument("--true-functional-col", default="functional_category")
    ...
    parser.add_argument("--pred-layout-col", default="predicted_layout_type")
    parser.add_argument("--pred-functional-col", default="predicted_functional_category")
    ...
    if args.ground_truth is not None:
        ...
        gt_cols = [args.pdf_col, args.page_col, args.true_start_col,
                   args.true_doctype_col, args.true_layout_col, args.true_functional_col]
    ...
    required = [args.pdf_col, args.page_col, args.true_start_col, args.pred_start_col,
                args.true_doctype_col, args.pred_doctype_col]
    ...
    if args.classes_json:
        ...
        key = {"document_type": "document_type", "layout_type": "layout_type",
               "functional_category": "functional_category"}[args.label_col]
    ...
    if "macro-f1" in metrics:
        ...
        for label, true_col, pred_col in [
            ...
            ("layout_type", args.true_layout_col, args.pred_layout_col),
            ("functional_category", args.true_functional_col, args.pred_functional_col),
        ]:
            ...
            line = (f"{label}: accuracy={r['accuracy']:.3f}  "
                    ...
                    f"(n_classes={r['n_classes']}, n_pages={r['n_pages']})")
    ...
    if "las" in metrics:
        true_label_col = {"document_type": args.true_doctype_col, "layout_type": args.true_layout_col,
                           "functional_category": args.true_functional_col}[args.label_col]
        pred_label_col = {"document_type": args.pred_doctype_col, "layout_type": args.pred_layout_col,
                           "functional_category": args.pred_functional_col}[args.label_col]
